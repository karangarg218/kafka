...
FILE_PATH = "C:/Users/karan/Desktop/kafka classes/cardekho_dataset.csv"
columns=['car_name', 'brand', 'model', 'vehicle_age', 'km_driven', 'seller_type',
       'fuel_type', 'transmission_type', 'mileage', 'engine', 'max_power',
       'seats', 'selling_price']

API_KEY = 'ZIXXQ3JIQ3BP25HY'
ENDPOINT_SCHEMA_URL  = 'https://psrc-mw731.us-east-2.aws.confluent.cloud'
API_SECRET_KEY = 'PX3V9UmnShXX10KyXRvoXqBBABQhEv8sHMbi++QxHPOJmyE0OBWh9EJ+vK7fJPXg'
BOOTSTRAP_SERVER = 'pkc-ymrq7.us-east-2.aws.confluent.cloud:9092'
SECURITY_PROTOCOL = 'SASL_SSL'
SSL_MACHENISM = 'PLAIN'
SCHEMA_REGISTRY_API_KEY = 'EJTGXCRSVZKVF2WD'
SCHEMA_REGISTRY_API_SECRET = 'jOxQPGlei+nLDKy3182wAppUKKDgoGcLNo1Cs/g0+k1n22A4TG9dNHx8BwkisdM0'
  ...
  "type": "object"
    ...
    try:
        for car in get_car_instance(file_path=FILE_PATH):
            ...
            print(car)
            producer.produce(topic="test-topic-1",
                            key=string_serializer("karan", car_to_dict),
